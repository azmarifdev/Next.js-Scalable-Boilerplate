...
export const env = createEnv({
  server: {
    ...
    AUTH_SESSION_TTL_SECONDS: optionalString,
    ...
    ALLOW_DB_SEED: optionalBooleanString,
    ALLOW_DB_RESET: optionalBooleanString,
    SEED_ADMIN_EMAIL: optionalString,
    SEED_ADMIN_PASSWORD: optionalString,
    SEED_USER_EMAIL: optionalString,
    SEED_USER_PASSWORD: optionalString,
    E2E_AUTH_EMAIL: optionalString,
    E2E_AUTH_PASSWORD: optionalString
  },
  client: {
  ...
  runtimeEnv: {
    ...
    ALLOW_DB_RESET: process.env.ALLOW_DB_RESET,
